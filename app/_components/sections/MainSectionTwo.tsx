...
const MainSectionTwo = () => {
  return (
    <section className=" px-[150px] py-[96px] flex  flex-col gap-[48px]">
      ...
      <div className="flex  gap-[48px] mx-auto">
        ...
        <GoalCard imagePath={imageTwo} title="Rast i Optimizacija Poslovanja">
      ...
      <div className="flex mx-auto gap-[48px]">
        ...
        <GoalCard imagePath={imageFive} title="Dugoročna podrška">
          Naša podrška ne završava nakon završetka programa; nastavljamo da vas
          podržavamo dugoročno kako biste ostvarili kontinuirani rast i uspeh.
        </GoalCard>
      </div>
    </section>
  );
